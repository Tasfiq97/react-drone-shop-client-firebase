...
const Login = () => {
  ...
  <h1> Please Login </h1>
        ...
        variant="standard" />
        <br />
  <Button type="submit" sx={{width:"75%",marginTop:"30px",backgroundColor:"black"}} variant="contained">Login</Button>
        </form>
       <Link to="/register" style={{textDecoration:"none"}}>
       <Button  sx={{width:"75%",marginTop:"30px"}} variant="text">New User? please register</Button>
       </Link>
  </Grid>
  <Grid item xs={12} md={6}>
    <div>
